 ...
 */
export declare const FLY_TO_SPEED = 1.4;
/**
 ...
 */
export declare function bboxViewport(map: mapboxgl.Map, bounds: mapboxgl.LngLatBoundsLike, delta?: number): mapboxgl.FlyToOptions;
/**
 ...
 * @returns
 */
export declare function getStaticBaseUrl(username: string, styleId: string): string;
