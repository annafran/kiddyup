...
var MapboxAddressConfirmation = class extends HTMLScopedElement {
  ...
  tryShow(autofillValues, optionsArg) {
    return __async(this, null, function* () {
      ...
      const validate = new MapboxValidate(__spreadValues({
        accessToken
      }, options));
...
var MapboxAddressAutofill = class extends HTMLScopedElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _autofill, new MapboxAutofill());
...
import {
  Evented,
  MapboxAutofill as MapboxAutofill2,
...
var AutofillCollection = class extends Evented {
  constructor({
    ...
    __privateAdd(this, _autofill2, new MapboxAutofill2());
