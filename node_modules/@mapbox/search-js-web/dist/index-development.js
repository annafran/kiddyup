  ...
  constructor(referenceEl, floatingEl, options) {
    ...
    this.update = () => __async(this, null, function* () {
      const config2 = {
        ...
        middleware: [
          (0, import_dom2.offset)(this.options.offset),
          this.options.flip && (0, import_dom2.flip)()
        ].filter(Boolean)
      };
      const { x, y } = yield (0, import_dom2.computePosition)(this.referenceEl, this.floatingEl, config2);
    ...
    this.destroy = (0, import_dom2.autoUpdate)(this.referenceEl, this.floatingEl, this.update);
  }
  get options() {
...
var MapboxAddressConfirmation = class extends HTMLScopedElement {
  ...
  tryShow(autofillValues, optionsArg) {
    return __async(this, null, function* () {
      ...
      const validate = new import_search_js_core4.MapboxValidate(__spreadValues({
        accessToken
      }, options));
...
var MapboxAddressAutofill = class extends HTMLScopedElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _autofill, new import_search_js_core7.MapboxAutofill());
...
var MapboxSearchBox = class extends HTMLScopedElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _search, new import_search_js_core8.MapboxSearch({}));
...
var AutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    this.listbox.session = new import_search_js_core10.SearchSession(autofillRef);
...
var AutofillCollection = class extends import_search_js_core10.Evented {
  constructor({
    accessToken,
    options,
    theme,
    ...
    __privateAdd(this, _autofill2, new import_search_js_core10.MapboxAutofill());
