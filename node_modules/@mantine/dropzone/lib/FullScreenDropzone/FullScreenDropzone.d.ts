...
import { MantineNumberSize, Selectors, DefaultProps } from '@mantine/core';
import { DropzoneStatus } from '../Dropzone';
import useStyles from './FullscreenDropzone.styles';
export declare type FullScreenDropzoneStylesNames = Selectors<typeof useStyles>;
...
export declare function FullScreenDropzone(props: FullScreenDropzoneProps): JSX.Element;
